...
# fPAKE Benchmark
## Acknowledgement to the implementation of using fPAKE protocol
...
We use their python implementation and add minor modification and adding couple of helper functions to implement our 
fPAKE protocol using our Random Robust Secret Sharing (RRSS) scheme. 

See their impelementation here: https://github.com/seemoo-lab/fastzip/tree/main/fPAKE-benchmark
## Requirements
