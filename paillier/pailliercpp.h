...
#ifndef RRSS_PAILLIERCPP_H
#define RRSS_PAILLIERCPP_H
...
/*
 * The values of p and q are stored to be used for generating Non-Interactive Zero Knowledge proofs on the generated
 * public keys are in good key. We need these values as the potential witnesses.
 *
 */
typedef struct
{
...
/*
 * Modified by Mohammad Hassan Ameri to support reversing oreder of the to byte transformation
 * */
void* paillier_plaintext_to_bytes_NegOrd( int len, paillier_plaintext_t* pt );
char* paillier_plaintext_to_str_NegOrd( paillier_plaintext_t* pt );
